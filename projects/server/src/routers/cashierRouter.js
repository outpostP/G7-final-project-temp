...
const {getProduct,payment,resetCart, transactionCashier, updateCart, deleteCartItems,createTransaction,cartTotal,getCartItems,getCart} = require('../controllers/cashier/cashierController');
